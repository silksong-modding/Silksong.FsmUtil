# Welcome to Silksong.FsmUtil.FsmUtil

[![NuGet Version](https://img.shields.io/nuget/v/ItemChanger.Core)](https://www.nuget.org/packages/Silksong.FsmUtil)
...
This is a library for interacting with PlayMakerFSMs in code.
